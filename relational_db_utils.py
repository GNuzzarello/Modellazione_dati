        ...
        if len(words) > 0:
            ...
            for word in words:
                if word not in result_word_count[emotion]:
                    ...
                    result_word_count[emotion][word] += 1 #Conteggio parole per emozione (ci servirà dopo)
        ...
        if len(emoticons) > 0:
            ...
            for emoticon in emoticons:
                ...
                if id_emoticon not in result_emojicon_count[emotion]:
                    ...
                    result_emojicon_count[emotion][id_emoticon] += 1 #Conteggio emoticons
        ...
        if len(hashtags) > 0:
            ...
            for hashtag in hashtags:
                if hashtag not in result_hashtag_count[emotion]:
                    ...
                    result_hashtag_count[emotion][hashtag] += 1 #conteggio hastag
